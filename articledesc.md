...
> **[Figure 3 Descriptor: An event-study plot titled "Parallel Trends Validation: EPI × Season Interactions (reference year: 2019)." Blue circles represent pre-treatment seasons 2012–2018, a grey square marks the 2019 reference at zero, and a red diamond marks the 2020 treatment year. Expected interaction coefficients hover marginally above zero but with overlapping 95% two-way cluster-robust confidence intervals crossing the zero line. A dashed horizontal zero line and vertical boundary markers at ±0.5 seasons around 2019 demarcate the pre- and post-treatment periods.]**
